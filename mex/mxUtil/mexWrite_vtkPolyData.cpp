...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[])
{
  ...
  float* vertexData = static_cast<float*>(mxGetData(prhs[1]));
  unsigned long* faceData = static_cast<unsigned long*>(mxGetData(prhs[2]));
  float* scalarData = static_cast<float*>(mxGetData(prhs[3]));
