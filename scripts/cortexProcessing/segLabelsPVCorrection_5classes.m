function [segOut, priorsOut] = segLabelsPVCorrection_5classes(priorsIn, ...
...
wm1PriorImg      = zeros(size(segIn));
wm2PriorImg      = zeros(size(segIn));
...
wm1PriorImg(indsForPriors)      = priorsIn(:, 3);
wm2PriorImg(indsForPriors)      = priorsIn(:, 4);
nonbrainPriorImg(indsForPriors) = priorsIn(:, 5);
...
wm1PriorImg(inds2)    = lambda * wm1PriorImg(inds2);
wm2PriorImg(inds2)    = lambda * wm2PriorImg(inds2);

csfPriorImg(inds2)    = 1 - cortexPriorImg(inds2) - ...
                            wm1PriorImg(inds2) - ...
                            wm2PriorImg(inds2) - ...
...
priorsOut(:, 3) = wm1PriorImg(indsForPriors);
priorsOut(:, 4) = wm2PriorImg(indsForPriors);
priorsOut(:, 5) = nonbrainPriorImg(indsForPriors);
