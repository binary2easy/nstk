...
post_wm1     = zeros([xsize ysize zsize], 'single');
post_wm2     = zeros([xsize ysize zsize], 'single');
post_gm      = zeros([xsize ysize zsize], 'single');
post_outlier = zeros([xsize ysize zsize], 'single');
...
for i = 1:num
    ...
    post_outlier(row, col, depth) = 1 - post_csf(row, col, depth) - post_gm(row, col, depth) - post_wm1(row, col, depth) - post_wm2(row, col, depth);
end
