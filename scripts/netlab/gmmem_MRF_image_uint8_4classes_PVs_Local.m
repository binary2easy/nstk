function [mix, options, errlog] = gmmem_MRF_image_uint8_4classes_PVs_Local(mix, x, options, partsmask, globalSeg)
...
for n = 1:niters
  ...
  if ( mod(n, 2) == 0 )
        ...
        if ( mix.ncentres == 4 )
            [LabeledSeg, mix] = LabelPVs_Seg_gmm_4classes_atlas_MEX(mix, results, ...
                                                csflabel, wmlabel, cortexlabel, pvlabel,...
                                                nonbrainlabel, partsmask, globalSeg);
        else          
            [LabeledSeg, mix] = LabelPVs_Seg_gmm_5classes_atlas_MEX(mix, results, ...
                                        csflabel, wmlabel, cortexlabel, pvlabel,...
                                        nonbrainlabel, partsmask, globalSeg);
        end
