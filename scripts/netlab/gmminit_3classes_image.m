...
function [mix, x, indexes] = gmminit_3classes_image(mix, imagedata, header,...
                            atlas_cortex, atlas_wm1, atlas_wm2, brainmask, ...
...
% new inputs: imagedata, atlas_cortex, atlas_wm1, atlas_wm2
...
points = union([i_wm1 j_wm1 k_wm1], [i_wm2 j_wm2 k_wm2], 'rows');
...
mix.priors = zeros(ndata, 3); % four classes
